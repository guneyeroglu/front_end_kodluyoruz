...
const createButton = (btnName) => {
  let btn = `<input type="button" id="${btnName}" class="btn btn-outline-dark btn-item" value=${btnName} />`;
...
const btnKorea = document
  .querySelector("#Korea")
  .addEventListener("click", listKoreaFoods);
